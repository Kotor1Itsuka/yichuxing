...
| -------- | ------ | ---------------------- | -------- |
| userName | string | Kotor1Itsuka           | 用户账号 |
| post     | string | 关于目前疫情形势的看法 | 帖子内容 |

- ### 返回参数

| 名称       | 类型   | 示例 | 说明         |
| ---------- | ------ | ---- | ------------ |
| permission | string | true | 是否允许发布 |
...
>接口地址：baseUrl/revokePost
>请求示例：baseUrl/revokePost
>支持协议：http/https
>请求方式：post返回格式：utf-8 json
...
| revoke   | string | true         | 撤销操作标识 |

- ### 返回参数

| 名称       | 类型   | 示例 | 说明         |
| ---------- | ------ | ---- | ------------ |
| permission | string | true | 是否删除成功 |
...
>接口地址：baseUrl/revokeComment
>请求示例：baseUrl/revokeComment
>支持协议：http/https
>请求方式：post返回格式：utf-8 json
...
| userName  | string | Kotor1Itsuka | 用户账号 |
| postId    | string | 1008611      | 帖子id   |
| commentId | string | 10001        | 评论id   |

- ### 返回参数

| 名称       | 类型   | 示例 | 说明         |
| ---------- | ------ | ---- | ------------ |
| permission | string | true | 是否撤销成功 |
